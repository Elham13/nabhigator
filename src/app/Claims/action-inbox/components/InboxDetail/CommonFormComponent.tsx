...
//   useEffect(() => {
//     if (caseDetail?.qaRMFindings) {
//       updateFormField(
//         "discrepanciesOrIrregularitiesObserved",
//         caseDetail?.qaRMFindings.discrepanciesOrIrregularitiesObserved
//       );
//       updateFormField(
//         "investigationSummary",
//         caseDetail?.qaRMFindings.investigationSummary
//       );
//       updateFormField(
//         "recommendation",
//         caseDetail?.qaRMFindings.recommendation
//       );

//       if (
//         !!caseDetail?.qaRMFindings?.otherRecommendation &&
//         caseDetail?.qaRMFindings?.otherRecommendation?.length > 0 &&
//         caseDetail?.qaRMFindings?.otherRecommendation?.every(
//           (el: any) => !!el?.value
//         )
//       ) {
//         updateFormField(
...
//       }
//     }
//   }, [caseDetail?.qaRMFindings, updateFormField]);
